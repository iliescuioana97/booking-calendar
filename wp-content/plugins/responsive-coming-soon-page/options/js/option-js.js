...
// media upload js
	...
	if(getCookie('rcsm_currentab')!=""){
		jQuery('ul.options_tabs li a#'+getCookie('rcsm_currentab')).parent().addClass('currunt active');
		jQuery('ul.options_tabs li a#'+getCookie('rcsm_currentab')).addClass('active');
	...
	jQuery('ul.options_tabs > li > a').click(function(){		
		...
		{ 		
			...
			document.cookie="rcsm_currentabChild=;expires="+Date(jQuery.now());
			document.cookie="rcsm_currentab="+divid;
			var add="div#"+divid;
	...
	if(getCookie('rcsm_currentab')!=""){
			var divid = getCookie('rcsm_currentab');
			var add="div#"+divid;
			var strlenght = add.length;
